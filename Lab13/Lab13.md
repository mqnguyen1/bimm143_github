...
Check that my metadata and count data matcb
...
![](Lab13_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](Lab13_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](Lab13_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
We will load AnnotationDbi and our Human data package to add gene
symbols to entrez IDs to our result object
...
```
    ...
    ## Info: Working in directory /Users/notquangnguyen/BIMM143/bimm143_github/Lab13
...
``` r
keggrespathways <- rownames(keggres$greater)[8:12]
keggresids = substr(keggrespathways, start=1, stop=8)
keggresids
```

    ## [1] "hsa04740" "hsa04010" "hsa04662" "hsa00511" "hsa00531"
